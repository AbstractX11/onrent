<template>
  <div id="form">
    ...
    <div id="oauth">
      <button @click="signInwithGoogle"><img src="../../assets/Image/googlelogo.svg" /></button>
      <button @click="signInwithFacebook"><img src="../../assets/Image/facebooklogo.svg" /></button>
    </div>
...
export default {
  setup() {
    ...
    return { form, handleSubmit, errors,signInwithGoogle,signInwithFacebook };
  },
};
</script>
